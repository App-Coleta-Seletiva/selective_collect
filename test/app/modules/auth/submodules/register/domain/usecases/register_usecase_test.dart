...
void main() {
  ...
  group('RegisterCase Test - Erros: ', () {
      ...
      test('Should return an instance of EmailError when email is empty', () async {
    ...
    test('Should return an instance of EmailError when email is entered wrong', () async {
     ...
     test('should return an instance of PasswordError when the password is less than 8', () async {
      when(() => params.email).thenReturn('email@email.com');
